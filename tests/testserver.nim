    ...
    proc processError(
      ...
      try:
        ...
        of RestRequestError.Invalid:
          await request.respond(Http201, "INVALID", HttpTable.init())
        of RestRequestError.NotFound:
          await request.respond(Http202, "NOT FOUND", HttpTable.init())
        of RestRequestError.InvalidContentBody:
          ...
          await request.respond(Http203, "CONTENT BODY", HttpTable.init())
        of RestRequestError.InvalidContentType:
          await request.respond(Http204, "CONTENT TYPE", HttpTable.init())
